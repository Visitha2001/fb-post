...
export default async function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <p className="text-xl mb-10 max-w-2xl text-slate-600 dark:text-slate-300">
